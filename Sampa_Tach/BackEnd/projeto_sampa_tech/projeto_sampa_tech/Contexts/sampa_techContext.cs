    ...
    public partial class sampa_techContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Data Source=DESKTOP-SRKL24T\\SQLEXPRESS; Initial Catalog= Sampa_tech; user Id=sa; pwd=sa@132;");
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-SCK41CA\\SQLEXPRESS; Initial Catalog= Sampa_tech; user Id=sa; pwd=Senai@132;");
            }
        }
